...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (ido-sort-mtime deadgrep bind-key go-mode eieio xelb diff-hl better-shell ssh go-rename editorconfig clang-format smex livereload websocket protobuf-mode magit gotest go-guru go-eldoc crontab-mode ag)))
