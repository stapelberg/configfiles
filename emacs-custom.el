...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (window-purpose esup use-package google-this term-keys bind-key go-mode eieio xelb diff-hl better-shell ssh go-rename editorconfig clang-format smex livereload websocket protobuf-mode magit gotest go-guru go-eldoc crontab-mode ag))))
